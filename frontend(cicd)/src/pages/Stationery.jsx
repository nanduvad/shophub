    ...
    <div className="min-h-screen bg-neutral-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center mb-8">
          <h1 className="text-3xl font-bold text-neutral-900">Home & Stationery</h1>
          <span className="ml-3 px-3 py-1 bg-accent-100 text-accent-700 text-xs font-medium rounded-full">
            {products.length} items
          </span>
        </div>

        <div className="relative">
          <div className="absolute -inset-4 bg-gradient-to-r from-secondary-200 via-accent-200 to-primary-200 blur-2xl opacity-30"></div>
              ...
              <div key={product.id} className="bg-white rounded-xl p-4 shadow-sm hover:shadow-md border border-neutral-100 transition-all duration-300 group">
                <Link to={`/product/stationery/${product.id}`} className="block mb-4">
                  <div className="relative overflow-hidden rounded-lg mb-4">
                    ...
                    />
                    {product.rating >= 4.8 && (
                      <span className="absolute top-2 left-2 px-2 py-1 bg-secondary-500 text-white text-xs font-bold rounded">
                        BEST SELLER
                      </span>
                    )}
                  </div>
                  <h2 className="text-lg font-semibold text-neutral-900 group-hover:text-accent-700 transition-colors truncate">{product.name}</h2>
                ...
                {cart[product.id] ? (
                  <div className="mt-4 flex items-center justify-between">
                    <div className="flex items-center border border-neutral-200 rounded-lg">
                      <button 
                        ...
                        className="p-2 hover:bg-accent-50 hover:text-accent-600 transition-colors rounded-l-lg"
                      >
                      ...
                      <button 
                        ...
                        className="p-2 hover:bg-accent-50 hover:text-accent-600 transition-colors rounded-r-lg"
                      >
                  ...
                  <div className="mt-4 flex justify-between items-center">
                    ...
                    <button 
                      ...
                      className="flex items-center justify-center p-2 rounded-full bg-accent-100 text-accent-700 hover:bg-accent-200 transition-colors"
                    >
